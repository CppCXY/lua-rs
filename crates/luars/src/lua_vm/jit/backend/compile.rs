    ...
    fn lower_numeric_steps_normalizes_move_alias_rhs_and_prunes_dead_move() {
        let insts = vec![
            ...
            TraceIrInst {
                ...
                raw_instruction: Instruction::create_abck(crate::OpCode::Mul, 4, 4, 11, false)
                    .as_u32(),
                kind: TraceIrInstKind::Arithmetic,
    ...
    fn lower_numeric_steps_forwards_adjacent_binary_temp_move() {
        let insts = vec![
            TraceIrInst {
                pc: 30,
                opcode: crate::OpCode::Mul,
                raw_instruction: Instruction::create_abck(crate::OpCode::Mul, 11, 4, 6, false)
                    .as_u32(),
                kind: TraceIrInstKind::Arithmetic,
    ...
    fn lower_linear_int_steps_consumes_integer_bitwise_and_shift_shapes() {
        let insts = vec![
            ...
            TraceIrInst {
                ...
                raw_instruction: Instruction::create_abck(crate::OpCode::BOr, 5, 4, 6, false)
                    .as_u32(),
                kind: TraceIrInstKind::Arithmetic,
                reads: vec![TraceIrOperand::Register(4), TraceIrOperand::Register(6)],
                writes: vec![TraceIrOperand::Register(5)],
            ...
            TraceIrInst {
                ...
                raw_instruction: Instruction::create_abck(crate::OpCode::Shr, 8, 7, 9, false)
                    .as_u32(),
                kind: TraceIrInstKind::Arithmetic,
    ...
    fn lower_linear_int_steps_consumes_integer_idiv_and_mod_shapes() {
        let insts = vec![
            ...
            TraceIrInst {
                ...
                raw_instruction: Instruction::create_abck(crate::OpCode::Mod, 5, 4, 6, false)
                    .as_u32(),
                kind: TraceIrInstKind::Arithmetic,
                reads: vec![TraceIrOperand::Register(4), TraceIrOperand::Register(6)],
                writes: vec![TraceIrOperand::Register(5)],
