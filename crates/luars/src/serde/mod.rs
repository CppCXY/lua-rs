...
#[cfg(feature = "serde")]
pub use serializer::{to_value as serialize_to_json, to_string as serialize_to_json_string};

#[cfg(feature = "serde")]
pub use deserializer::{from_value as deserialize_from_json, from_str as deserialize_from_json_str};
...
#[cfg(feature = "serde")]
pub fn json_to_lua(json_value: &serde_json::Value, vm: &mut crate::lua_vm::LuaVM) -> Result<LuaValue, String> {
    deserialize_from_json(json_value, vm)
}

/// Convert a JSON string to a Lua value
#[cfg(feature = "serde")]
pub fn json_string_to_lua(json_str: &str, vm: &mut crate::lua_vm::LuaVM) -> Result<LuaValue, String> {
